...
<div class="row">
    <div class="col-sm-8 offset-sm-2">
        ...
        <tr>
         <td>Matric.no</td>
         <td>:</td>
         <td><input type="text" name="matricNo" size="10" value="{{ $students->matric_no }}"></td>
        </tr>
        <tr>
         <td>Gender</td>
         <td>:</td>
         <td><input type="text" name="gender" value="{{ $students->gender }}" readonly>
        ...
        <tr>
         ...
         <td>:</td>
         <td><input type="text" name="maritalstat" value="{{ $students->marital_status }}" readonly>
        ...
        <tr>
         <td>Active</td>
         <td>:</td>
         <td><input type="text" name="active" size="40" value="{{ $students->active_status }}" readonly>
